...
import { HomePage, LoginPage, SignupPage, NotFoundPage, UserProfilePage, LandingPage, DocumentsPage, DocumentDetailsPage, CoachingsPage, CoachingDetailsPage, ClassroomPage, TeachersForStudentPage, TeacherProfilePage, StudentProfilePage, ChatsPage, StudentsForTeacherPage } from './pages';
