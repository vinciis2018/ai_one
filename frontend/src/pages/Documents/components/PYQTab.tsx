  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between p-2 bg-white border-b border-gray-200 shrink-0">
        <h3 className="text-sm font-semibold text-gray-700">Previous Year Questions</h3>
      ...
      <div className="px-4 space-y-4">
        ...
        {pyqQuestions && pyqQuestions.length > 0 ? (
          ...
          <div className="text-center py-12 bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl border-2 border-dashed border-purple-100">
            <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3">
              <i className="fi fi-rr-lightbulb-question flex items-center justify-center text-purple-400 text-xl"></i>
            </div>
        ...
        {/* Info Box */}
        <div className="bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-100 rounded-lg p-3">
